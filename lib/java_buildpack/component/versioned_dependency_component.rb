...
module JavaBuildpack
  module Component
    ...
    class VersionedDependencyComponent < BaseComponent
      ...
      # @return [Void]
      def download_jar(jar_name_param = self.get_jar_name, target_directory = @droplet.sandbox, name = @component_name)
        super(@version, @uri, jar_name_param, target_directory, name)
      end
